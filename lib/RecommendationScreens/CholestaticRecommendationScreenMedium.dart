...
class CholestaticRecommendationScreenMedium extends StatelessWidget {
  const CholestaticRecommendationScreenMedium({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Implement these practices to minimize the risk of Cholestatic Liver Disease",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontFamily: 'RobotoCondensed',
                  ...
                  Padding(
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          "Your liver shows moderate signs of cholestasis, indicating a higher risk of progression to more severe liver conditions. Immediate lifestyle modifications are essential to halt or reverse disease progression:\n\n"

                              "• Initiate a structured weight management plan. Aim for a gradual reduction of 5–10% of your body weight over six months through a combination of diet and exercise.  \n\n"
                              ...
                              "• Limit alcohol consumption. Even moderate alcohol intake can worsen liver damage in cholestatic liver disease patients. It's advisable to minimize or abstain from alcohol.  \n\n"
                              ...
                              "Taking these steps can significantly reduce liver inflammation and improve overall liver function."
,
                          style: TextStyle(
