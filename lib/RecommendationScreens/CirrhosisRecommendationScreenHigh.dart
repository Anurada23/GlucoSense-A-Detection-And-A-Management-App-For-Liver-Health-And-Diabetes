...
class CirrhosisRecommendationScreenHigh extends StatelessWidget {
  const CirrhosisRecommendationScreenHigh({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Consult a hepatologist/Doctor promptly to manage and mitigate the progression of Cirrhosis Disease.",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontFamily: 'RobotoCondensed',
