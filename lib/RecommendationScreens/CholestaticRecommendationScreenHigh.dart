...
class CholestaticRecommendationScreenHigh extends StatelessWidget {
  const CholestaticRecommendationScreenHigh({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Consult a hepatologist/Doctor promptly to manage and mitigate the progression of Cholestatic Liver Disease.",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontFamily: 'RobotoCondensed',
