...
class ResultsScreenA extends StatelessWidget {
  const ResultsScreenA({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 21),
                    Text(
                      '​Acanthosis nigricans is a skin condition marked by dark, velvety patches in body folds like the neck, armpits, and groin. Often associated with insulin resistance and obesity, it can signal underlying health issues such as diabetes. Treatment focuses on addressing the root cause, including lifestyle changes and managing related conditions.',
